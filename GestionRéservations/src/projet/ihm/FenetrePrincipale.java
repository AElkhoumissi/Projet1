...
public class FenetrePrincipale extends javax.swing.JFrame {
    ...
    public FenetrePrincipale() {
        ...
        db = new DataBase("jdbc:sqlite:gestionVols.db");
        initComponents();
        table();
        table1();
    ...
    public void table() {
        ...
        vol.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public void table1() {
        ...
        //reservation.setModel(new ResultSetTableModel(rs));
         reservation.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        jPanel5.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 1200, 210));

        jLabel27.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel27.setText("Développeurs :");
        jPanel5.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, -1, -1));

        jLabel28.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel28.setText("N° d'examen :");
        jPanel5.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 470, -1, -1));

        jLabel29.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel29.setText("Prénom :");
        jPanel5.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 380, -1, -1));

        jLabel30.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel30.setText("Nom       :");
        jPanel5.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 480, -1, -1));

        jLabel31.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel31.setText("Niveau         :");
        jPanel5.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 360, -1, -1));

        te2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel5.add(te2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 470, 240, 30));

        te3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel5.add(te3, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 350, 240, 30));

        te1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel5.add(te1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 370, 240, 30));

        te4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jPanel5.add(te4, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 460, 240, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Etes vous sûre de "
                +" vouloir supprimer cette réservation", "Attention!!!", 
